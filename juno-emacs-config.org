...
Attempt to sort out and make literate my main emacs config file, which was messy and confusing. A superior literate config is [[https://github.com/munen/emacs.d][Alain Lafon's]]. 

I want to add few more things:
- zsh working reasonably as default Emacs shell
