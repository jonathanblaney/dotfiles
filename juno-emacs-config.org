...
- use-package implementation, maybe
...
Tab stopped working to expand in normal mode. Tried to explicitly bind it:
#+begin_src emacs-lisp
;;  (evil-define-key 'normal org-mode-map (kbd "TAB") 'org-cycle)
;; this gives me an error, although not sure why
#+end_src
...
* Evil
** Broken tab fix
Tab will no longer expand collapsed headings in normal mode.
#+begin_src emacs-lisp 
